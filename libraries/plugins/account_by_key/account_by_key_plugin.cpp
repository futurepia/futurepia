...
account_by_key_plugin::account_by_key_plugin( futurepia::app::application* app )
...
FUTUREPIA_DEFINE_PLUGIN( account_by_key, futurepia::account_by_key::account_by_key_plugin )
