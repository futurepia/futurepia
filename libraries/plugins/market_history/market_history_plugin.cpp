...
using futurepia::protocol::fill_order_operation;
      ...
      for( auto bucket : _tracked_buckets )
      {
         ...
         if( itr == bucket_idx.end() )
         {
            db.create< bucket_object >( [&]( bucket_object& b )
            {
               ...
               if( op.open_pays.symbol == FUTUREPIA_SYMBOL )
               {
                  b.high_futurepia = op.open_pays.amount;
                  b.high_fpch = op.current_pays.amount;
                  b.low_futurepia = op.open_pays.amount;
                  b.low_fpch = op.current_pays.amount;
                  b.open_futurepia = op.open_pays.amount;
                  b.open_fpch = op.current_pays.amount;
                  b.close_futurepia = op.open_pays.amount;
                  b.close_fpch = op.current_pays.amount;
                  b.futurepia_volume = op.open_pays.amount;
                  b.fpch_volume = op.current_pays.amount;
               }
               else
               {
                  b.high_futurepia = op.current_pays.amount;
                  b.high_fpch = op.open_pays.amount;
                  b.low_futurepia = op.current_pays.amount;
                  b.low_fpch = op.open_pays.amount;
                  b.open_futurepia = op.current_pays.amount;
                  b.open_fpch = op.open_pays.amount;
                  b.close_futurepia = op.current_pays.amount;
                  b.close_fpch = op.open_pays.amount;
                  b.futurepia_volume = op.current_pays.amount;
                  b.fpch_volume = op.open_pays.amount;
               }
            });
         }
         else
...
FUTUREPIA_DEFINE_PLUGIN( market_history, futurepia::market_history::market_history_plugin )
