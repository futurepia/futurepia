...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_fpch = 0;                   ///< FPCH paid for author rewards
   share_type           author_rewards_total_futurepia_value = 0;     ///< FPC Value of author rewards
   share_type           author_rewards_payout_fpch_value = 0;      ///< FPCH Value of author rewards at time of payout
   uint32_t             curation_reward_payouts = 0;              ///< Number of curation reward payouts.
   share_type           curation_rewards_futurepia_value = 0;         ///< FPC Value of curation rewards
   share_type           curation_rewards_payout_fpch_value = 0;    ///< FPCH Value of curation rewards at time of payout
   uint32_t             liquidity_reward_payouts = 0;             ///< Number of liquidity reward payouts
   share_type           liquidity_rewards = 0;                    ///< Amount of FPC paid as liquidity rewards
   ...
   share_type           futurepia_sent = 0;                           ///< FPC sent from this account
   share_type           futurepia_received = 0;                       ///< FPC received by this account
   share_type           fpch_sent = 0;                             ///< FPCH sent from this account
   share_type           fpch_received = 0;                         ///< FPCH received by this account
   uint32_t             fpch_interest_payments = 0;                ///< Number of times interest was paid to FPCH
   share_type           fpch_paid_as_interest = 0;                 ///< Amount of FPCH paid as interest
   share_type           futurepia_received_from_withdrawls = 0;       ///< FPC received from this account's vesting withdrawals
   share_type           futurepia_received_from_routes = 0;           ///< FPC received from another account's vesting withdrawals
   ...
   share_type           limit_order_futurepia_paid = 0;               ///< FPC paid by limit orders
   share_type           limit_order_futurepia_received = 0;           ///< FPC received from limit orders
   share_type           limit_order_fpch_paid = 0;                 ///< FPCH paid by limit orders
   share_type           limit_order_fpch_received = 0;             ///< FPCH received by limit orders
...
FC_REFLECT( futurepia::account_statistics::account_stats_bucket_object,
   ...
   (author_rewards_fpch)
   (author_rewards_total_futurepia_value)
   (author_rewards_payout_fpch_value)
   (curation_reward_payouts)
   (curation_rewards_futurepia_value)
   (curation_rewards_payout_fpch_value)
   ...
   (fpch_sent)
   (fpch_received)
   (fpch_interest_payments)
   (fpch_paid_as_interest)
   (futurepia_received_from_withdrawls)
   (futurepia_received_from_routes)
   ...
   (limit_order_futurepia_paid)
   (limit_order_futurepia_received)
   (limit_order_fpch_paid)
   (limit_order_fpch_received)
   (total_pow)
   (estimated_hashpower)
)
