...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->futurepia_transferred                      += b.futurepia_transferred;
   this->fpch_transferred                        += b.fpch_transferred;
   this->fpch_paid_as_interest                   += b.fpch_paid_as_interest;
   ...
   this->fpch_paid_to_authors                    += b.fpch_paid_to_authors;
   this->liquidity_rewards_paid                 += b.liquidity_rewards_paid;
   this->fpch_conversion_requests_created        += b.fpch_conversion_requests_created;
   this->fpch_to_be_converted                    += b.fpch_to_be_converted;
   this->fpch_conversion_requests_filled         += b.fpch_conversion_requests_filled;
   this->futurepia_converted                        += b.futurepia_converted;
