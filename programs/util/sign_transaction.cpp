...
{
   futurepia::protocol::transaction     tx;
   std::string                        wif;
};
...
struct tx_signing_result
{
   ...
   futurepia::protocol::public_key_type key;
   futurepia::protocol::signature_type  sig;
};
...
int main(int argc, char** argv, char** envp)
{
   ...
   while( std::cin )
   {
      ...
      sres.key = futurepia::protocol::public_key_type( priv_key.get_public_key() );
